...
def VGGish(pump=None,
    ...
    with tf.name_scope(name):
        ...
        if include_top:
            ...
            x = dense(4096, name='fc1/fc1_1')(x)  # , input_shape=[512])(x)
        ...
        dense = partial(tfkl.Dense, activation='sigmoid')
        print('Here1')
        if model_label == 'vgg2':
            print('Here2')
            # x = dense(100, name="fc1/fc1_3")(x)
            x = dense(5, name="fc1/fc1_4")(x)
        x = dense(1, name="fc1/fc1_5")(x)
